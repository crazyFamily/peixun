    ...
    >
      <div class="select-box">
        ...
        <div class="search-result-container">
          <p class="tip">已选人群 {{selectedList.length}}</p>
...
<script>
import { fetchListManulUsers, fetchListColumnManulUsers } from '@/fetch/caseCenter'
import { fetchInsertCaseManulVisibleUsers, fetchInsertColumnManulVisibleUsers } from '@/fetch/caseCenter'
    ...
    return {
      ...
      fnMapping: {
        case: {
          ...
          fetchListManulUsers: fetchListManulUsers
        },
        column: {
  ...
  methods: {
    ...
    umExportHandle() {
      return new Promise(async (resolve, reject) => {
        ...
        let { successList, failList } = await this.fetchInsertManulVisibleUsers({ data })
    ...
    async searchUmNameHandle() {
      ...
      this.searchUmNameList = await this.fetchListManulVisibleUsers({
