  ...
  <div class="course_container course">
    <el-card class="box-card">
      <el-form :model="queryForm" ref="queryForm" class="form-container">
        <el-form-item label="案例名称：" prop="courseName">
          <el-input v-model="queryForm.courseName" placeholder="请输入案例名称"> </el-input>
        </el-form-item>
        <el-form-item label="案例关键字：" prop="keyword">
          <el-input placeholder="请输入案例关键字" v-model="queryForm.keyword"></el-input>
        </el-form-item>
        <el-form-item label="授课讲师：" prop="teacherUm">
          <el-input placeholder="请输入讲师姓名" v-model="queryForm.teacherUm"></el-input>
        </el-form-item>
        <el-form-item label="案例系列：" prop="courseClassify">
          <el-cascader
            clearable
        ...
        <el-form-item label="案例标签：" prop="courseTagIds">
          <el-cascader
            clearable
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns: [
        { type: 'index', label: '序号' },
        { label: '案例名称', prop: 'courseName' },
        { label: '案例系列', prop: 'courseClassifyName' },
        {
          label: '案例标签',
          width: '166',
          prop: '',
