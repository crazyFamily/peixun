<template>
  <div class="full dfc bgf new-pc-container">
...
export default {
  ...
  methods: {
    ...
    async _getDetailData() {
      let { attachList, content, title, id } = await fetchFindRealInfo({
        id: this.$route.params.id
      })
      this.queryForm = { ...this.queryForm, id, title, content, attachList }
