  ...
  <div class="dept-dispense-wrapper">
    ...
    <el-card class="search-form-card search-card-fixed-center">
      <el-form :model="queryForm" inline>
        ...
        <el-form-item label="被分配机构">
          <gc-institution v-model="queryForm.blgDepts" ref="institutionRef" busiType="LS" :left-show="false" :defaultShow="false" orgUrl="/fn/user/selectFixedTree" :otherParams="{authority: 'planModule'}" />
        </el-form-item>
        <div class="buttons">
...
import { fetchDeptDispensePlanDetail, fetchExportDeptDispensePlan, fetchExportDispensePlanDetail, fetchListDeptDispensePlan } from '@/fetch/statementCentre'
const baseParams = {
...
const resetData = async () => {
  const total = queryForm.total
  await reset(queryData)
  queryForm.total = total
}
