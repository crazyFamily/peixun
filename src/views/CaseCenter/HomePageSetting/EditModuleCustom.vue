  ...
  <div class="setting-box">
    <div class="setting-container">
      ...
      >
        ...
        <!-- <el-button class="add-item-button" type="primary" @click="addItemInfoHandle" >添加</el-button> -->
        <el-button class="add-item-button" type="primary" @click="addItemInfoHandle" >添加</el-button>
      </div>
    ...
    ></add-items> -->
    <select-source :suggest-size="suggestSize[activeType]" ref="selectSourceRef" @comfirm="selectSourceComfirm"></select-source>
  </div>
</template>
  ...
  data() {
    return {
      configForm: {
        ...
        columnContentShowRowRadio: '-1', // 是否显示全部
  ...
  methods: {
    ...
    saveHandle() {
     ...
     this.$emit('save', {
        ...
        columnStyle: this.activeType, // 显示样式
    ...
    itemHoverChangeHandle(type, index) {
      ...
      switch (type) {
        ...
        case 'edit':
          ...
          this.$refs.selectSourceRef.open(this.addItemInfo)
          break
        case 'remove':
